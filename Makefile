...
lint: ## check style with flake8
	python -m flake8 mps_automation tests

type: ## Run mypy
	python3 -m mypy mps_automation tests

test: ## run tests on every Python version with tox
	python3 -m pytest -cov=mps_automation tests

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/mps_automation.rst
	...
	sphinx-apidoc -o docs/ mps_automation
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
